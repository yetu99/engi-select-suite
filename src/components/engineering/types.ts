...
export const ashbyCharts: AshbyChartConfig[] = [
  ...
  { id: 'sigma-vs-rho', title: 'Streckgrenze vs. Dichte', xKey: 'density', yKey: 'yieldStrength', xLabel: 'Dichte ρ [kg/m³]', yLabel: 'Streckgrenze σ_y [MPa]', logX: true, logY: true },
  { id: 'kic-vs-sigma', title: 'Bruchzähigkeit vs. Streckgrenze', xKey: 'yieldStrength', yKey: 'youngsModulus', xLabel: 'Streckgrenze σ_y [MPa]', yLabel: 'E-Modul E [GPa] (≈ K_IC-Proxy)', logX: true, logY: true },
  { id: 'sigma-vs-temp', title: 'Streckgrenze vs. Temperatur', xKey: 'maxServiceTemp', yKey: 'yieldStrength', xLabel: 'Max. Einsatztemperatur T [°C]', yLabel: 'Streckgrenze σ_y [MPa]', logX: false, logY: true },
  ...
  { id: 'cost-vs-density', title: 'Kosten vs. Dichte', xKey: 'density', yKey: 'relativeCost', xLabel: 'Dichte ρ [kg/m³]', yLabel: 'Relative Kosten C_rel [–]', logX: true, logY: false },
];
