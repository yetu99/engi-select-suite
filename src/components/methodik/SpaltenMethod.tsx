...
import {
  ...
  AlertTriangle, Users, FileText, ArrowRight
} from 'lucide-react';
...
const steps: SpaltenStep[] = [
  ...
  },
  {
    ...
    description: 'Grundlegendes Wissen und optimierte Ansätze aus der Erfahrung extrahieren. Dokumentation des Verbesserungspotenzials (KVP — Kontinuierlicher Verbesserungsprozess).',
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed max-w-3xl">
          ...
          zur systematischen Problemlösung in der Produktentwicklung. Der Name ist ein Akronym der 
          sieben Module — jedes kann sequenziell oder situativ (eventorientiert) durchlaufen werden.
        </p>
        <a
          href="/papers/SPALTEN_Albers_2005.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 text-xs text-primary hover:underline mt-1"
        >
          <BookOpen className="w-3.5 h-3.5" /> Originalpaper lesen (Albers et al., ICED 2005)
        </a>
      </div>

      {/* Honeycomb overview — letter bar */}
            ...
            <button
              ...
              className={`relative w-10 h-10 sm:w-12 sm:h-12 rounded-lg font-bold text-base sm:text-lg transition-all duration-300 ${
                isActive
                  ...
                  : isDone
                    ? 'text-white/80 opacity-70 hover:opacity-90'
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            ...
            <div className="rounded-md border border-border/40 px-3 py-2 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Teamzusammensetzung modulspezifisch anpassen für optimale Kompetenzabdeckung.</p>
              </div>
            </div>
          </div>
        ...
        <CardContent className="p-4 flex gap-3">
          ...
          <div className="text-xs text-foreground/80 leading-relaxed space-y-1">
            ...
            <p>
              ...
              Lösungsauswahl). Dieses Auf und Ab ähnelt einem Wabenmodell und sichert ein optimales 
              Aufwand-Nutzen-Verhältnis.
            </p>
            <p>
              Nicht alle Module müssen immer durchlaufen werden — je nach Problem kann z. B. nach der 
              Problemeingrenzung direkt zur Umsetzung gesprungen werden, wenn Ursache und Lösung bekannt sind.
            </p>
          </div>
        </CardContent>
      </Card>
